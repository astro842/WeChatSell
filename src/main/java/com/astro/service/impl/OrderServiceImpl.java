...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        //6.new  把购物车的商品状态state设为1 标识已经下单成功
        buyerCarDao.updateCarState(orderDTO.getBuyerOpenid());
    ...
    @Override
    public List<OrderMaster> findOrderList(String buyerOpenid) {

        return orderMasterRepository.findByBuyerOpenid(buyerOpenid);
    }
